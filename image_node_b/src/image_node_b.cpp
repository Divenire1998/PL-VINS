...
int main(int argc, char **argv) {
  ...
  m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile("/home/divenire/catkin_plvins/src/PL-VINS/config/euroc/euroc_config_fix_extrinsic.yaml");
